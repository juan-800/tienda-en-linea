    ...
    if($id > 0 ){
        ...
        if($productos != null){
            foreach ($productos as $clave => $cantidad) {
                ...
                $ql_insert = $con->prepare("INSERT INTO detalle_compra(	id_compra, id_producto, nombre, precio, cantidad) VALUES(?,?,?,?,?)");
                $ql_insert->execute([$id, $clave, $row_prod['nombre'], $precio_desc, $cantidad]);
